 ...
 * @author Adrian
 */
public class ListaVehiculosInterfaz extends javax.swing.JInternalFrame {


    /**
     * Creates new form ListaVehiculosInterfaz
     */
    
    public ListaVehiculosInterfaz() {
        super("Lista de Vehiculos",true,true,false,true);
